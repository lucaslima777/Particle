...
public class Particle extends View {
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.Particle);
        if (typedArray != null) {
            bgColor = typedArray.getColor(R.styleable.Particle_sherderBgColor, bgColor);
            titleColor = typedArray.getColor(R.styleable.Particle_sherderTextColor, titleColor);
            paperColor = typedArray.getColor(R.styleable.Particle_sherderPaperColor, paperColor);
            paperEnterColor = typedArray.getColor(R.styleable.Particle_sherderPaperEnterColor, paperEnterColor);
            title = typedArray.getString(R.styleable.Particle_sherderText);
            int type = typedArray.getInteger(R.styleable.Particle_sherderType, 0);
            ...
            sherderProgress = typedArray.getBoolean(R.styleable.Particle_sherderProgress, true);
            sherderTextShadow = typedArray.getBoolean(R.styleable.Particle_sherderTextShadow, sherderTextShadow);
            typedArray.recycle();
        }
        initPaint();
    }
